...
from .algos import DigestAlgorithm, EncryptionAlgorithm, RSAESOAEPParams, RSASSAPSSParams, _ForceNullParameters
from .core import (
    Any,
    Asn1Value,
    BitString,
...
class ECPrivateKey(Sequence):
    ...
    def __setitem__(self, key, value):
        ...
        if key == "private_key":
            ...
            key == "parameters" and isinstance(self["parameters"], ECDomainParameters) and self["parameters"].name != "implicit_ca"
        ):
