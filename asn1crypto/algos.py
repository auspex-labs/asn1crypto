...
class RSAESOAEPParams(Sequence):
    _fields = [
        ("hash_algorithm", DigestAlgorithm, {"explicit": 0, "default": {"algorithm": "sha1"}}),
        (
            "mask_gen_algorithm",
            MaskGenAlgorithm,
            {"explicit": 1, "default": {"algorithm": "mgf1", "parameters": {"algorithm": "sha1"}}},
        ),
        ("p_source_algorithm", PSourceAlgorithm, {"explicit": 2, "default": {"algorithm": "p_specified", "parameters": b""}}),
    ]
...
class EncryptionAlgorithm(_ForceNullParameters, Sequence):
    ...
    def encryption_mode(self):
        ...
        if encryption_algo[0:7] in {"aes128_", "aes192_", "aes256_"}:
