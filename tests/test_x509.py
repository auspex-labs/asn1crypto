...
from asn1crypto import core, pem, util, x509
...
class X509Tests(unittest.TestCase):
    ...
    def compare_name_info():
        return (
            (True, x509.Name.build({"common_name": "Will Bond"}), x509.Name.build({"common_name": "will bond"})),
            (True, x509.Name.build({"common_name": "Will Bond"}), x509.Name.build({"common_name": "will\tbond"})),
            (
                True,
                x509.Name.build({"common_name": "Will Bond"}),
                x509.Name.build({"common_name": "Will Bond \U0001D173\U000E007F"}),
            ),
            (
                True,
                x509.Name.build(
            ...
            (
                True,
                x509.Name.build({"2.5.4.6": "US", "common_name": "Will Bond"}),
                x509.Name.build({"country_name": "US", "common_name": "Will Bond"}),
            ),
            (
                False,
                x509.Name.build({"common_name": "Will Bond", "0.9.2342.19200300.100.1.1": "wbond"}),
                x509.Name.build(
                    {
                        "common_name": "Will Bond",
                    }
            ...
            (
                False,
                x509.Name.build({"country_name": "US", "common_name": "Will Bond"}),
                x509.Name.build({"country_name": "US", "state_or_province_name": "Massachusetts", "common_name": "Will Bond"}),
            ),
        )
    ...
    def test_build_name_printable(self):
        utf8_name = x509.Name.build({"country_name": "US", "state_or_province_name": "Massachusetts", "common_name": "Will Bond"})
        ...
        printable_name = x509.Name.build(
            {"country_name": "US", "state_or_province_name": "Massachusetts", "common_name": "Will Bond"}, use_printable=True
        )
    ...
    def signature_algo_info():
        return (
            ...
            ("keys/test-rsapss.crt", "rsassa_pss", "sha256"),
        )
        ...
        return (
            ...
            (
                ...
                [
                    ...
                    util.OrderedDict(
                        [("type", "pda_date_of_birth"), ("values", [datetime(1971, 10, 14, 12, 0, tzinfo=util.timezone.utc)])]
                    ),
    ...
    def key_usage_value_info():
        return (
            ...
            ("keys/test-inter-der.crt", None),
            ("keys/test-third-der.crt", None),
            ("geotrust_certs/GeoTrust_Universal_CA.crt", {"digital_signature", "key_cert_sign", "crl_sign"}),
            ("geotrust_certs/GeoTrust_Primary_CA.crt", {"key_cert_sign", "crl_sign"}),
            ("geotrust_certs/GeoTrust_EV_SSL_CA_-_G4.crt", {"key_cert_sign", "crl_sign"}),
            ("geotrust_certs/codex.crt", {"digital_signature", "key_encipherment"}),
            ("lets_encrypt/isrgrootx1.pem", {"key_cert_sign", "crl_sign"}),
            ...
            ("globalsign_example_keys/SSL1.cer", {"digital_signature", "key_encipherment"}),
            ("globalsign_example_keys/SSL2.cer", {"digital_signature", "key_encipherment"}),
            ("globalsign_example_keys/SSL3.cer", {"digital_signature", "key_encipherment"}),
            ("rfc3739.crt", {"non_repudiation"}),
        )
                ...
                util.OrderedDict(
                    [
                        (
                            "permitted_subtrees",
                            [
                                util.OrderedDict([("base", "onlythis.com"), ("minimum", 0), ("maximum", None)]),
                                util.OrderedDict(
                                    [
                                        (
                                            "base",
                        ...
                        (
                            "excluded_subtrees",
                            [
                                util.OrderedDict([("base", "0.0.0.0/0"), ("minimum", 0), ("maximum", None)]),
                                util.OrderedDict([("base", "::/0"), ("minimum", 0), ("maximum", None)]),
                            ],
                        ),
                    ]
                ),
    ...
    def crl_distribution_points_value_info():
        return (
            ...
            (
                ...
                [
                    util.OrderedDict(
                        [("distribution_point", ["http://g1.symcb.com/GeoTrustPCA.crl"]), ("reasons", None), ("crl_issuer", None)]
                    )
                ],
            ),
            (
                ...
                [
                    util.OrderedDict(
                        [("distribution_point", ["http://gm.symcb.com/gm.crl"]), ("reasons", None), ("crl_issuer", None)]
                    )
                ],
            ),
            ("lets_encrypt/isrgrootx1.pem", None),
            (
                ...
                [
                    util.OrderedDict(
                        [("distribution_point", ["http://crl.root-x1.letsencrypt.org"]), ("reasons", None), ("crl_issuer", None)]
                    )
                ],
            ),
            (
    ...
    def certificate_policies_value_info():
        return (
            ...
            (
                "lets_encrypt/letsencryptauthorityx1.pem",
                [
                    util.OrderedDict([("policy_identifier", "2.23.140.1.2.1"), ("policy_qualifiers", None)]),
                    util.OrderedDict(
                        [
            ...
            (
                "rfc3739.crt",
                [
                    util.OrderedDict([("policy_identifier", "1.3.36.8.1.1"), ("policy_qualifiers", None)]),
                ],
            ),
        )
    ...
    def authority_information_access_value_info():
        return (
            ...
            (
                "geotrust_certs/GeoTrust_EV_SSL_CA_-_G4.crt",
                [util.OrderedDict([("access_method", "ocsp"), ("access_location", "http://g2.symcb.com")])],
            ),
            (
                "geotrust_certs/codex.crt",
                [
                    util.OrderedDict([("access_method", "ocsp"), ("access_location", "http://gm.symcd.com")]),
                    util.OrderedDict([("access_method", "ca_issuers"), ("access_location", "http://gm.symcb.com/gm.crt")]),
                ],
            ),
            ("lets_encrypt/isrgrootx1.pem", None),
            (
                "lets_encrypt/letsencryptauthorityx1.pem",
                [
                    util.OrderedDict([("access_method", "ocsp"), ("access_location", "http://ocsp.root-x1.letsencrypt.org/")]),
                    util.OrderedDict(
                        [("access_method", "ca_issuers"), ("access_location", "http://cert.root-x1.letsencrypt.org/")]
                    ),
                ],
            ),
            (
            ...
            (
                "globalsign_example_keys/SSL1.cer",
                [
                    util.OrderedDict([("access_method", "ocsp"), ("access_location", "http://ocsp.exampleovca.com/")]),
                    util.OrderedDict(
                        [
    ...
    def issuer_serial_info():
        return (
            ...
            (
                "keys/test-inter-der.crt",
                b"\xdd\x8a\x19x\xae`\x19=\xa7\xf8\x00\xb9\xfbx\xf8\xedu\xb8!\xf8\x8c" b"\xdb\x1f\x99'7w\x93\xb4\xa4'\xa0:1590137",
            ),
            (
                "keys/test-third-der.crt",
            ...
            ("rfc3739.crt", b"@\xde\x1b\xdb\xdc3a\x89:'D\xaf.G' \xb4<\xb3R8\xca;y\x8e\xfb\xef\x14\xbcE\x05F" b":1234567890"),
        )
    ...
    def authority_key_identifier_info():
        return (
            ...
            ("rfc3739.crt", b"\x00\x01\x02\x03\x04\x05\x06\x07\x08\t\n\x0b\x0c\r\x0e\x0f\xfe\xdc\xba\x98"),
        )
    ...
    def self_signed_info():
        return (
            ("keys/test-der.crt", "maybe"),
            ("keys/test-inter-der.crt", "no"),
            ("keys/test-third-der.crt", "no"),
            ("geotrust_certs/GeoTrust_Universal_CA.crt", "maybe"),
            ("geotrust_certs/GeoTrust_Primary_CA.crt", "maybe"),
            ("geotrust_certs/GeoTrust_EV_SSL_CA_-_G4.crt", "no"),
            ("geotrust_certs/codex.crt", "no"),
            ("lets_encrypt/isrgrootx1.pem", "maybe"),
            ...
            ("globalsign_example_keys/rootCA.cer", "maybe"),
    ...
    def test_parse_certificate(self):
        ...
        self.assertEqual("v3", tbs_certificate["version"].native)
        self.assertEqual(13683582341504654466, tbs_certificate["serial_number"].native)
        self.assertEqual("sha256_rsa", signature["algorithm"].native)
        self.assertEqual(None, signature["parameters"].native)
        self.assertEqual(
            util.OrderedDict(
                [
                    ("country_name", "US"),
        ...
        self.assertEqual(datetime(2015, 5, 6, 14, 37, 16, tzinfo=util.timezone.utc), validity["not_before"].native)
        self.assertEqual(datetime(2025, 5, 3, 14, 37, 16, tzinfo=util.timezone.utc), validity["not_after"].native)
        self.assertEqual(
            util.OrderedDict(
                [
                    ("country_name", "US"),
        ...
        self.assertEqual("rsa", subject_public_key_algorithm["algorithm"].native)
        self.assertEqual(None, subject_public_key_algorithm["parameters"].native)
        self.assertEqual(
        ...
        self.assertEqual(65537, subject_public_key["public_exponent"].native)
        self.assertEqual(None, tbs_certificate["issuer_unique_id"].native)
        self.assertIsInstance(tbs_certificate["issuer_unique_id"], core.Void)
        self.assertEqual(None, tbs_certificate["subject_unique_id"].native)
        self.assertIsInstance(tbs_certificate["subject_unique_id"], core.Void)

        self.maxDiff = None
        for extension in extensions:
            self.assertIsInstance(extension, x509.Extension)
        self.assertEqual(
            [
                util.OrderedDict(
                    [
                ...
                util.OrderedDict(
                    [
                        ...
                        ("critical", False),
                        ("extn_value", util.OrderedDict([("ca", True), ("path_len_constraint", None)])),
                    ]
                ),
            ],
            extensions.native,
    ...
    def test_parse_dsa_certificate(self):
        ...
        self.assertEqual("v3", tbs_certificate["version"].native)
        self.assertEqual(14308214745771946523, tbs_certificate["serial_number"].native)
        self.assertEqual("sha256_dsa", signature["algorithm"].native)
        self.assertEqual(None, signature["parameters"].native)
        self.assertEqual(
            util.OrderedDict(
                [
        ...
        self.assertEqual(datetime(2015, 5, 20, 13, 9, 2, tzinfo=util.timezone.utc), validity["not_before"].native)
        self.assertEqual(datetime(2025, 5, 17, 13, 9, 2, tzinfo=util.timezone.utc), validity["not_after"].native)
        self.assertEqual(
            util.OrderedDict(
                [
                    ("country_name", "US"),
        ...
        self.assertEqual("dsa", subject_public_key_algorithm["algorithm"].native)
        self.assertEqual(
            util.OrderedDict(
                [
                    (
    ...
    def test_parse_dsa_certificate_inheritance(self):
        ...
        self.assertEqual("v3", tbs_certificate["version"].native)
        self.assertEqual(2, tbs_certificate["serial_number"].native)
        self.assertEqual("sha1_dsa", signature["algorithm"].native)
        self.assertEqual(None, signature["parameters"].native)
        self.assertEqual(
            util.OrderedDict(
                [
        ...
        self.assertEqual(datetime(2010, 1, 1, 8, 30, tzinfo=util.timezone.utc), validity["not_before"].native)
        self.assertEqual(datetime(2030, 12, 31, 8, 30, tzinfo=util.timezone.utc), validity["not_after"].native)
        self.assertEqual(
            util.OrderedDict(
                [
                    ("country_name", "US"),
        ...
        self.assertEqual("dsa", subject_public_key_algorithm["algorithm"].native)
        self.assertEqual(None, subject_public_key_algorithm["parameters"].native)
        self.assertEqual("dsa", subject_public_key_info.algorithm)
        self.assertEqual(None, subject_public_key_info.hash_algo)
    ...
    def test_parse_ec_certificate(self):
        ...
        self.assertEqual("v3", tbs_certificate["version"].native)
        self.assertEqual(15854128451240978884, tbs_certificate["serial_number"].native)
        self.assertEqual("sha256_ecdsa", signature["algorithm"].native)
        self.assertEqual(None, signature["parameters"].native)
        self.assertEqual(
            util.OrderedDict(
                [
        ...
        self.assertEqual(datetime(2015, 5, 20, 12, 56, 46, tzinfo=util.timezone.utc), validity["not_before"].native)
        self.assertEqual(datetime(2025, 5, 17, 12, 56, 46, tzinfo=util.timezone.utc), validity["not_after"].native)
        self.assertEqual(
            util.OrderedDict(
                [
                    ("country_name", "US"),
        ...
        self.assertEqual("ec", subject_public_key_algorithm["algorithm"].native)
        self.assertEqual("ecdpVer1", public_key_params["version"].native)
        self.assertEqual("prime_field", field_id["field_type"].native)
        self.assertEqual(
            115792089210356248762697446949407573530086143415290314195533631308867097853951, field_id["parameters"].native
        )
        self.assertEqual(
        ...
        self.assertEqual(b"\xC4\x9D\x36\x08\x86\xE7\x04\x93\x6A\x66\x78\xE1\x13\x9D\x26\xB7\x81\x9F\x7E\x90", curve["seed"].native)
        self.assertEqual(
        ...
        self.assertEqual(
            115792089210356248762697446949407573529996955224135760342422259061068512044369, public_key_params["order"].native
        )
        self.assertEqual(1, public_key_params["cofactor"].native)
        self.assertEqual(None, public_key_params["hash"].native)
        self.assertEqual(
    ...
    def test_parse_ed25519_certificate(self):
        ...
        self.assertEqual("ed25519", signature["algorithm"].native)
        self.assertEqual(None, signature["parameters"].native)
        self.assertEqual(None, subject_public_key_info["algorithm"]["parameters"].native)
        self.assertEqual("ed25519", subject_public_key_algorithm["algorithm"].native)
        self.assertEqual(
            b"\x17ZZS\xb8\x8e=\xc7\xf9P\xf9\xe8\xcd=\x9a\x15\x06\xec=\xcf\xfa" b"\xa3\xfb\x93M\xb3\x89V\xce*N\xed",
    ...
    def test_parse_ed448_certificate(self):
        ...
        self.assertEqual("ed448", signature["algorithm"].native)
        self.assertEqual(None, signature["parameters"].native)
        self.assertEqual(None, subject_public_key_info["algorithm"]["parameters"].native)
        self.assertEqual("ed448", subject_public_key_algorithm["algorithm"].native)
        self.assertEqual(
    ...
    def test_trusted_certificate(self):
        ...
        self.assertEqual(aux["trust"].native, ["email_protection"])

        self.assertEqual(aux["reject"].native, ["client_auth", "server_auth"])
    ...
    def test_iri_with_port(self):
        ...
        self.assertEqual(
            ...
            [
                util.OrderedDict(
                    [("distribution_point", ["http://www.pki.admin.ch/crl/SSLCA01.crl"]), ("reasons", None), ("crl_issuer", None)]
                ),
                util.OrderedDict(
                    [
                        (
    ...
    def test_teletex_that_is_really_latin1(self):
        self.assertEqual("{}", x509.DirectoryString.load(b"\x14\x02{}").native)
