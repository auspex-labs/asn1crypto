...
class UtilTests(unittest.TestCase):
    ...
    def test_iri_to_uri(self):
        ...
        self.assertEqual(
            ...
            util.iri_to_uri(
                "ldap://directory.d-trust.net/CN=D-TRUST Root Class 3 CA 2 2009," "O=D-Trust GmbH,C=DE?certificaterevocationlist"
            ),
        )
        self.assertEqual(
            ...
            b"O=D-Trust%20GmbH,C=DE?certificaterevocationlist",
            util.iri_to_uri(
                "ldap://directory.d-trust.net/CN=D-TRUST Root Class 3 CA 2 EV 2009," "O=D-Trust GmbH,C=DE?certificaterevocationlist"
            ),
        )
