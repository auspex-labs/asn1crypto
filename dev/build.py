...
def run():
    ...
    if has_tests_package:
        print("Building {}_tests-{}".format(package_name, version_mod.__version__))
        ...
        os.rename(os.path.join(tests_dist_dir, tests_sdist), os.path.join(dist_dir, tests_sdist))
        os.rename(os.path.join(tests_dist_dir, tests_whl), os.path.join(dist_dir, tests_whl))
