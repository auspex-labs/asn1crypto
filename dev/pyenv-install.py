...
def run(version=None):
    ...
    proc = subprocess.Popen("command -v pyenv", shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    proc.communicate()
    if proc.returncode != 0:
        proc = subprocess.Popen(["brew", "install", "pyenv"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    ...
    try:
        ...
        proc = subprocess.Popen(args, stdout=subprocess.PIPE, stderr=subprocess.PIPE, stdin=stdin, env=env)
